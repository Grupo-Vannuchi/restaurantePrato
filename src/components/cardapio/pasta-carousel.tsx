        ...
        {photos.map((foto, i) => (
          ...
          >
            <Image
               ...
               * nenhum: é banda e processamento gastos para devolver a mesma
               * foto esticada.
               *
               ...
               * `100vw` prometia até 1280 quando a caixa já estava travada em
               * 768 pelo `max-w-3xl`. A condição de 832 é onde `100vw - 64`
               * alcança 768 e o limite passa a mandar.
               *
